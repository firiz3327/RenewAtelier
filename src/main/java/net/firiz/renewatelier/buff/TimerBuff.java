...
public class TimerBuff implements IBuff {
    ...
    public TimerBuff(EntityStatus status, BuffData buffData, int duration) {
        this(status, buffData.buffValueType, buffData.level, buffData.type, duration, buffData.limitDuration, buffData.x, buffData.y);
    }

    public TimerBuff(EntityStatus status, BuffData buffData, int duration, int x) {
        this(status, buffData.buffValueType, buffData.level, buffData.type, duration, buffData.limitDuration, x, buffData.y);
    }

    public TimerBuff(EntityStatus status, BuffValueType buffValueType, int level, BuffType type, int duration, int limitDuration, int x, @Nullable String y) {
        this.status = status;
