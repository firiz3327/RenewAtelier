...
public enum HorseTier {
    ...
    private final int requireMoney;

    HorseTier(int tier, boolean rare, int maxLevel, double baseSpeed, double speedMag, double baseJump, double jumpMag, double rankUpPercent, double rankDownPercent, int requireMoney) {
        this.tier = tier;
        this.rare = rare;
