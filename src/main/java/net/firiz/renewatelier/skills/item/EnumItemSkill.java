package net.firiz.renewatelier.skills.item;
...
import net.firiz.renewatelier.skills.item.skill.*;
...
public enum EnumItemSkill {
    ...
    public int getCooldown(@Nullable Char character, @NotNull AlchemyItemStatus itemStatus) {
        ...
        long coolTimeMillis = (long) (itemStatus.getAlchemyMaterial().itemCooldown() * 1000) - CObjects.nullIfFunction(character, c -> c.getCharStats().getSpeed(), 0);
