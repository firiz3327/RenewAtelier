...
public class PayloadPacket {
    ...
    static {
        ...
        try {
            @MinecraftVersion("1.17") final Method method = StandardMessenger.class.getDeclaredMethod(
                    "addToOutgoing",
                    Plugin.class,
                    String.class
            );
    ...
    public static void sendBrand(final Player player) {
        ...
        final String brand = ServerConstants.SERVER_NAME + " (ping: " + player.getPing() + ")" + ChatColor.RESET;
